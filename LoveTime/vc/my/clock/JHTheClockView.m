...
- (instancetype)init
{
    ...
    if (self) {
        ...
        self.theDialColor = [UIColor qmui_colorWithHexString:@"F4489D"];
        self.hourColor = [UIColor blackColor];
        self.minuteColor = [UIColor blueColor];
        self.secondColor = [UIColor qmui_colorWithHexString:@"F4489D"];
...
-(instancetype)initWithFrame:(CGRect)frame{
    if ([super initWithFrame:frame]) {
        self.backgroundColor = [UIColor clearColor];
        self.theDialColor = [UIColor qmui_colorWithHexString:@"F4489D"];
        self.hourColor = [UIColor qmui_colorWithHexString:@"5C8EB5"];
        self.minuteColor = [UIColor qmui_colorWithHexString:@"DB413E"];
        self.secondColor = [UIColor qmui_colorWithHexString:@"F4489D"];
        self.timer = [NSTimer scheduledTimerWithTimeInterval:1 target:self selector:@selector(upDate) userInfo:nil repeats:YES];
        [[NSRunLoop currentRunLoop] addTimer:self.timer forMode:NSRunLoopCommonModes];
    }
...
//    表盘外圆
    ...
    bgImageLayer.contents = (id)[UIImage imageNamed:@"p_clock_Img"].CGImage;
